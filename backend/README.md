...
## Project Structure
    ...
    ├── scheduling_app_temp_37515  # Django project configurations
...
1. Clone this repo and `cd scheduling_app_temp_37515`
...
2. Clone this repo and `cd scheduling_app_temp_37515`
